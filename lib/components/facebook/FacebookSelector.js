    ...
    (0, _map3.default)(reactions, function (reaction) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_FacebookSelectorEmoji2.default, {
          icon: typeof customIcons !== "undefined" ? customIcons.find(variant, reaction) : _icons2.default.find(variant, reaction),
          label: typeof labels[reaction] !== "undefined" ? labels[reaction] : reaction,
          reaction: reaction,
          onSelect: onSelect
        })
      );
